...
from utils import (
	...
	get_geo_attrs, msgs_dataset_columns,get_last_download_context
)
...
# Collect JSON files
json_files_path = f'{main_path}/{channel}/*_messages.json'
...
for f in json_files:
	...
	'''
	(start_msg,num_msgs) = get_last_download_context(f'{main_path}/{channel}/log_downloads.csv')
